    ...
    <>
      ...
      <div className="max-w-6xl mx-auto space-y-16 text-gray-800">
        <header className="text-center space-y-4">
          <h1 className="text-5xl md:text-6xl font-extrabold">📝 Team Tips</h1>
          <p className="text-lg md:text-xl font-normal text-gray-500 max-w-2xl mx-auto">Tips and tricks from my colleagues.</p>
        </header>
