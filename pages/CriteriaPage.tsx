...
import { StrategyRequirementIcon, CalculatorIcon, GlobeIcon, DocumentTextIcon } from '../components/Icons';
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto space-y-12 text-gray-800">
        <header className="text-center space-y-4">
          ...
          <p className="text-lg md:text-xl font-normal text-gray-500 max-w-3xl mx-auto">What are our expectations for viability with shifting manufacturing and tariffs?</p>
        </header>
          ...
          <section>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm border border-slate-200 hover:shadow-md transition-shadow">
                <div className="flex items-center">
                    <StrategyRequirementIcon className="w-12 h-12 text-sky-500" />
                    <div className="ml-6">
            ...
            <h2 className="text-2xl font-bold mb-6">Sourcing Viability (Ex-China)</h2>
             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <InfoCard 
                    ...
                    value=">25% CM"
                    valueStyles="text-amber-600"
                    description="For the US market, we will accept a contribution margin above 25% after all tariffs are applied."
                />
                <InfoCard 
